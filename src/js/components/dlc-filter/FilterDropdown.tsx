...
const FilterDropdown: React.FC<FilterDropdownProps> = ({
  ...
  return (
    <div ref={dropdownRef} className="relative w-220 shrink-2 xl:w-250">
      {/* Dropdown Button */}
      <button
      ...
      >
        <span className="fp-captital-title lg:text-28 min-w-0 truncate" dangerouslySetInnerHTML={{ __html: displayLabel }}></span>

...
use FP\Post_Type\DLC;

defined( 'ABSPATH' ) || exit;

class DLC_Category extends Taxonomy {

	const NAME = 'dlc_category';
	const SLUG = 'dlc-category';
	...
	public function config(): array {
		$singular = __( 'DLC Category', 'fp' );
		$plural   = __( 'DLC Categories', 'fp' );
		...
		$args = [
			...
			'show_in_nav_menus'  => false, // = private
			'show_in_rest'       => true,

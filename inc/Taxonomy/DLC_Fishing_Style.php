...
class DLC_Fishing_Style extends Taxonomy {

	const NAME = 'dlc_fishing_style';
	const SLUG = 'dlc-fishing-style';
	...
	public function config(): array {
		$singular = __( 'Fishing Style', 'fp' );
		$plural   = __( 'Fishing Styles', 'fp' );
